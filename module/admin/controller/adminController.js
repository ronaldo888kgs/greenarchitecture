...
registeradmin = function (req,res) { 
    ...
    admin.save(function (err , admin) {
        ...
        let token = jwt.sign({admin_id:admin._id,email: admin.email,phone:admin.phone,private_key:admin.private_key,public_key:admin.public_key,paypal:admin.paypal},
                    config.secret_key,
...
exports.update = function(req,res) {
    admins.findOne({_id:req.decoded.admin_id}, function (err, admin) {
        ...
        admin.private_key = req.body.private_key ? req.body.private_key : admin.private_key;           
